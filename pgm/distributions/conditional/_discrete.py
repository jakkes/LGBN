...
class Discrete(conditional.Base):
    ...
    def __init__(
        ...
        Args:
            ...
            variable_names (Sequence[str]): Names of the output variables.
            conditioned_names (Sequence[str]): Names of the conditioned variables.
        """
        ...
        self._conditioned_names = list(conditioned_names)
    ...
    def by_evidence(self, evidence: np.ndarray) -> "distributions.Discrete":
        ...
        return distributions.Discrete(
            self._values, self._probabilities[i], self.variable_names
        )

    def marginalize(
        self, distribution: "distributions.Discrete"
    ) -> "distributions.Discrete":
        distribution = distribution.reorder(self._conditioned_names).cast(
            distributions.Discrete
        )
        ...
        return distributions.Discrete(self._values, new_p, self.variable_names)
